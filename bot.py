...
# -------------------------------------------------------------
# 🎛️ DISCORD SLASH COMMANDS (ลงทะเบียนคำสั่งครบถ้วน)
# -------------------------------------------------------------
...
async def register_xbox(ctx, xbox_name: str):
    xbox_to_destination = xbox_name.lower()
    xbox_to_discord[xbox_to_destination] = ctx.author.id
