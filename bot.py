...
sos_channel_id = None
sos_role_id = None  # Role ที่จะแท็กเมื่อกด SOS
...
# คำสั่งค้างส่งกลับ Minecraft (Mute/Unmute Sync)
pending_mc_commands = []
...
def check_access(user_id: int) -> bool:
    """เช็กว่าผู้ใช้งานตรงกับ ID 933529869487321161 หรือไม่"""
    return user_id in CONFIG["ALLOWED_USERS"]

def create_unauthorized_warning_embed():
    """Embed แจ้งเตือนเมื่อบัญชีไม่อยู่ในรายการอนุญาต"""
    embed = discord.Embed(
...
async def on_voice_state_update(member: discord.Member, before: discord.VoiceState, after: discord.VoiceState):
    """ระบบ Mute/Unmute Sync ระหว่าง Discord และ Minecraft"""
    xbox_name = None
    ...
    if before.self_mute != after.self_mute or before.mute != after.mute:
        ...
        logging.info(f"🔊 สั่งการ {action} สำหรับ {xbox_name} ในเกม")

# =============================================================
# 💻 SLASH COMMANDS (ตรวจสอบสิทธิ์ ID 933529869487321161)
# =============================================================
