...
# =============================================================
# 🤖 BOT INITIALIZATION & EVENTS (FIXED DUPED COMMANDS)
# =============================================================
...
async def on_ready():
    ...
    # เคลียร์คำสั่งระดับ Guild เก่าที่อาจซ้ำค้างอยู่ออกทั้งหมด
    for guild in bot.guilds:
        bot.tree.clear_commands(guild=guild)
        await bot.tree.sync(guild=guild)
    
    # Sync คำสั่ง Slash Commands แบบ Global เพียงทางเดียว
