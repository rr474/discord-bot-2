...
# -------------------------------------------------------------
# 🎛️ DISCORD SLASH COMMANDS (แก้ไขให้รองรับการเลือกห้องแบบเสถียร)
# -------------------------------------------------------------
...
@bot.tree.command(name="set-default-voice", description="ตั้งค่าห้อง Lobby เริ่มต้น (เลือกห้องเสียงที่ต้องการ)")
